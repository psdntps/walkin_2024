...
<?php
	...
	if($role == 'admin') {
        ...
        <div><a href="../api/person/exportCF"> <img src="../glogin/assets/export_icon.png" style="height: 50px;" alt="คลิกเพื่อ export ไฟล์" ></a></div>
        </div>
        <br>
        <?php
        // echo "<center><table border='1'>";
        // echo "<tr><th rowspan='2'>ครั้งที่</th><th rowspan='2'>รหัสวิชา</th><th rowspan='2'>ชื่อวิชาภาษาอังกฤษ</th><th rowspan='2'>วันที่สอบ</th><th colspan='2'>10.00 - 12.00</th><th rowspan='2' style='text-align: center;'>จำนวนรวม</th></tr>";
        ...
        echo "<center><table border='1'>";
        echo "<tr bgcolor='#ACE1AF'><th rowspan='2'>ครั้งที่</th><th rowspan='2'>รหัสวิชา</th><th rowspan='2'>ชื่อวิชาภาษาอังกฤษ</th><th rowspan='2'>วันที่สอบ</th><th colspan='2' style='text-align: center; padding: 5px;'>10.00 - 12.00</th><th rowspan='2' style='text-align: center;'>จำนวนรวม</th></tr>";
